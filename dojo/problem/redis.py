...
class Problem:
    ...
    def update_name_sev_sla(self, finding):
    ...
    # This method is used in problems table to show SLA
...
def get_redis_client():
    return redis.Redis(host=settings.REDIS_CONTAINER_HOSTNAME, port=6379, decode_responses=True)
