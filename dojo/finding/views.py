...
class ListFindings(View, BaseListFindings):
    ...
    def filter_findings_by_risk(self, findings, user_votes, model_votes, risk_filter):
    ...
    def get(self, request: HttpRequest, product_id: int | None = None, engagement_id: int | None = None):
        ...
        if risk_filter:
            ordered_findings = self.filter_findings_by_risk(ordered_findings, user_votes, model_votes, risk_filter)
